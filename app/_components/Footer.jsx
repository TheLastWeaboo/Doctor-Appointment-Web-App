...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl justify-center text-center flex flex-col items-center px-4 py-16 sm:px-6 lg:px-8">
    ...
    At Logoipsum, we are committed to delivering innovative and effective solutions tailored to meet your needs. Our team of experts is dedicated to providing exceptional service and ensuring your success. Discover how we can help you achieve your goals and make a lasting impact.
    </p>
